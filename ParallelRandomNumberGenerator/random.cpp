...
void Random::Initialize() {
    ...
    // Leggi i numeri primi dal file "Primes"
    ifstream Primes("../ParallelRandomNumberGenerator/Primes.txt");
    if (Primes.is_open()) {
        Primes >> p1 >> p2;
    }
    else {
    ...
    if (input.is_open()) {
        while (!input.eof()) {
            ...
            if (property == "RANDOMSEED") {
                ...
                // Inizializza il generatore con i semi letti e i numeri primi
